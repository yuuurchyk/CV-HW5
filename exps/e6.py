...
# classification on CIFAR10, from embeddings of e3
EXP_NAME = "exp6"
EPOCHS_NUM = 1000
BATCH_SIZE = 4096
EMBEDDING_SIZE = 128
...
def main():
    ...
    d = torch.load(os.path.join(get_exps_root(), 'exp3', '50.pth'))
    ...
    train_dataset = Cifar10(True, get_augmentations(AUGS, random_resized_crop_size=32), device)
    validation_dataset = Cifar10(False, get_augmentations(AUGS, random_resized_crop_size=32), device)
